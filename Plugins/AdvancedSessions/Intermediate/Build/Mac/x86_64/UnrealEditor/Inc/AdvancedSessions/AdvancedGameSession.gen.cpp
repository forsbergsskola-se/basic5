...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AAdvancedGameSession()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AAdvancedGameSession_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AAdvancedGameSession, 3891897678);
